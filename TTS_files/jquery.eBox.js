...
function $_eBox(option){
        var defaults={
	        size:{width:500,height:300,padding:0,borderWidth:"1px"},
		    title:{show:true,html:"标题"},
		    content:{url:false,html:"内容"},
		    skin:"./../script/css/eBox/default/eBox.css",
         ...
         $("<span></span>").prependTo(myBox).attr("class","eBox-close").append("<img onclick='showNoticePage()' alt=\"\" src=\""+skinPath+"close.gif\" />").css("position","absolute");		 
		 //bind event
